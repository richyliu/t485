...
!(function(e) {
  ...
  function(e, t, n) {
    ...
    ;(t.flatMap = function(e, t) {
      ...
      (t.groupBy = function(e, t) {
        return e.reduce((e, n) => {
          const r = t(n)
          return e.hasOwnProperty(r) || (e[r] = []), e[r].push(n), e
        }, {})
      }),
                  ...
                  for (var u = 0; u < d.length; ++u) {
                    ...
                    for (
                      ...
                      if (!(x instanceof o)) {
                        if (m && y != t.length - 1) {
                          ...
                          for (
                            var k = C.index + (f && C[1] ? C[1].length : 0),
                              ...
                              P = t.length;
                            S < P &&
                            (E < _ || (!t[S].type && !t[S - 1].greedy));
                            ++S
                          )
                            k >= (E += t[S].length) && (++y, (w = E))
                          if (t[y] instanceof o) continue
                          ;(j = S - y), (x = e.slice(w, E)), (C.index -= w)
                        } else {
                          p.lastIndex = 0
                          var C = p.exec(x),
                            j = 1
                        ...
                        if (C) {
                          f && (b = C[1] ? C[1].length : 0)
                          _ = (k = C.index + b) + (C = C[0].slice(b)).length
                          var N = x.slice(0, k),
                            $ = x.slice(_),
                            A = [y, j]
                          N && (++y, (w += N.length), A.push(N))
                          var M = new o(c, h ? r.tokenize(C, h) : C, g, C, m)
                          if (
                            (A.push(M),
                            $ && A.push($),
    ...
    !(function() {
      if (
        ...
        var e = {
          ...
          n = {},
          r = "components/",
          o = Prism.util.currentScript()
        if (o) {
          var i = /\bplugins\/autoloader\/prism-autoloader\.(?:min\.)js$/i,
            s = /[\w-]+\.(?:min\.)js$/i
          if (o.hasAttribute("data-autoloader-path"))
            r = o
            ...
            var a = o.src
            i.test(a)
              ? (r = a.replace(i, "components/"))
              : s.test(a) && (r = a.replace(s, "components/"))
          }
        }
          ...
          e.element &&
            ...
            (function(e, n) {
              ...
              !r &&
                ...
                (r = o.getAttribute("data-dependencies")),
                c((r = r ? r.split(/\s*,\s*/g) : []), function() {
                  d(e, function() {
      ...
      function d(r, o, i) {
        ...
        var a = function() {
            ...
            if (
              (e || (e = n[r] = { callbacks: [] }),
              e.callbacks.push({ success: o, error: i }),
              !s && Prism.languages[r])
            )
              u(r, "success")
            else if (!s && e.error) u(r, "error")
            else if (s || !e.loading) {
              ;(e.loading = !0),
                (function(e, t, n) {
                  ...
                  function() {
                    ;(e.loading = !1), u(r, "success")
                  },
                  function() {
                    ;(e.loading = !1), (e.error = !0), u(r, "error")
                  }
                )
            }
          },
          d = e[(r = t[r] || r)]
        d && d.length ? c(d, a, i) : a()
      }
      function u(e, t) {
        if (n[e]) {
          for (var r = n[e].callbacks, o = 0, i = r.length; o < i; o++) {
            var s = r[o][t]
            s && setTimeout(s, 0)
          }
          r.length = 0
  ...
  function(e, t, n) {
    ...
    const h = (e, t) => {
      ...
      b = /([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/
    class g {
      constructor(e, t, n) {
        ;(this.__parts = []),
          (this.template = e),
    ...
    const M = new (class {
      handleAttributeExpressions(e, t, n, r) {
        ...
        return "@" === o
          ? [new $(e, t.slice(1), r.eventContext)]
          : "?" === o
          ? [new P(e, t.slice(1), n)]
          : new _(e, t, n).parts
      }
    ...
    function R(e, t) {
      ...
      for (; o.nextNode(); ) {
        ...
        for (
          ...
          (s.index = null !== d ? -1 : s.index - l), (i = L(r, i)), (s = r[i])
      }
    ...
    const D = e => t => {
        ...
        if (((o = r.keyString.get(i)), void 0 === o)) {
          ...
          U && window.ShadyCSS.prepareTemplateDom(n, e),
            (o = new p(t, n)),
            r.keyString.set(i, o)
        }
      ...
      (se.render = (e, t, n) => {
        ...
        if (
          (((e, t, n) => {
            ...
            void 0 === r &&
              (s(t, t.firstChild),
              F.set(t, (r = new E(Object.assign({ templateFactory: T }, n)))),
              r.appendInto(t)),
              r.setValue(e),
              r.commit()
          })(e, l, Object.assign({ templateFactory: D(r) }, n)),
          a)
        ) {
          const e = F.get(l)
          F.delete(l)
          const n = e.value instanceof g ? e.value.template : void 0
          W(r, l, n), s(t, t.firstChild), t.appendChild(l), F.set(t, e)
        }
    ...
    var ve = {
        ...
        next: function(e) {},
        error: function(e) {
          if (be.useDeprecatedSynchronousErrorHandling) throw e
          ge(e)
        },
        complete: function() {},
      },
              ...
              if ("object" == typeof n) {
                n instanceof t
                  ...
                  : ((i.syncErrorThrowable = !0),
                    (i.destination = new Pe(i, n)))
                break
              }
            default:
              ;(i.syncErrorThrowable = !0), (i.destination = new Pe(i, n, r, o))
          }
          return i
        }
        return (
        ...
        return (
          ...
          (t.prototype.next = function(e) {
            if (!this.isStopped && this._next) {
              ...
              be.useDeprecatedSynchronousErrorHandling && t.syncErrorThrowable
          ...
          (t.prototype.error = function(e) {
            if (!this.isStopped) {
              var t = this._parentSubscriber,
                n = be.useDeprecatedSynchronousErrorHandling
              if (this._error)
                ...
                n ? ((t.syncErrorValue = e), (t.syncErrorThrown = !0)) : ge(e),
                  this.unsubscribe()
              else {
          ...
          (t.prototype.__tryOrUnsub = function(e, t) {
            try {
              ...
              if (
                (this.unsubscribe(), be.useDeprecatedSynchronousErrorHandling)
              )
                throw e
              ge(e)
            }
          ...
          (t.prototype.__tryOrSetError = function(e, t, n) {
            ...
            try {
              ...
              return be.useDeprecatedSynchronousErrorHandling
    ...
    var $e = (function() {
      ...
      return (
        ...
        (e.prototype.subscribe = function(e, t, n) {
          var r = this.operator,
            o = (function(e, t, n) {
              ...
              return e || t || n ? new Ee(e, t, n) : new Ee(ve)
            })(e, t, n)
          if (
            (r
        ...
        (e.prototype.forEach = function(e, t) {
          var n = this
          return new (t = Ae(t))(function(t, r) {
            var o
            o = n.subscribe(
              function(t) {
                try {
        ...
        (e.prototype.toPromise = function(e) {
          var t = this
          return new (e = Ae(e))(function(e, n) {
            var r
            t.subscribe(
              function(e) {
                return (r = e)
        ...
        "function" == typeof t
          ? function(r) {
              return r.pipe(
                We(function(n, r) {
                  return ((o = e(n, r)),
                  i ? qe(o, i) : o instanceof $e ? o : new $e(Ve(o))).pipe(
                    Be(function(e, o) {
                      return t(n, e, r, o)
                    })
                  )
      ...
      Je = (function(e) {
        ...
        return (
          ...
          (t.prototype._innerSub = function(e, t, n) {
            var r = new Te(this, t, n),
              o = this.destination
            o.add(r)
            var i = (function(e, t, n, r, o) {
              if ((void 0 === o && (o = new Te(e, n, r)), !o.closed))
                return t instanceof $e ? t.subscribe(o) : Ve(t)(o)
        ...
        function t(t, n, r, o) {
          ...
          return (
            ...
            fe(n)
              ...
              : n &&
                ((i._context = n),
                (i._tapNext = n.next || je),
                (i._tapError = n.error || je),
                (i._tapComplete = n.complete || je)),
            i
          )
        }
        return (
    ...
    const et = (function() {
      ...
      return (
        ...
        null === r && 1 === e.length && e[0] instanceof $e
          ? e[0]
          : Ke(n)(Ge(e, r))
      )
    })(
    ...
    let st = class extends se {
      ...
      renderTitle() {
        const e = this
        return this.context && this.titlePostfix
          ? O`<h1 class="display-4">${this.context.name}${
              e.titlePostfix
                ? O`<small class="text-muted"> - ${e.titlePostfix}</small>`
                : void 0
            }</h1>`
          : void 0
      }
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      renderFileReport() {
        return this.context && this.report && this.context.file
          ? O`<mutation-test-report-file .model="${this.context.file}"></mutation-test-report-file>`
          : void 0
      }
      renderTotals() {
    ...
    let lt = class extends se {
      ...
      render() {
        return O`<div class="popover popover-${this.context} ${
          this.show ? "show" : "hide"
        }">
  ...
  <div class="popover-body">
    ...
    let bt = class extends se {
      constructor() {
        super(...arguments),
          ...
          (this.showMoreInfo = e => {
            this.dispatchEvent(
              new CustomEvent(gt, { bubbles: !0, detail: e, composed: !0 })
            )
          })
      }
      render() {
        return O`${this.renderButton()}${this.renderCode()}`
      }
      renderButton() {
        if (this.show && this.mutant)
          return O`<mutation-test-report-popup ?show="${
            this.showPopup
          }" context="${pt(this.mutant.status)}" header="${
            this.mutant.mutatorName
          }">${this.renderPopupBody(
            this.mutant
          )}<span class="mutant-toggle badge badge-${
            this.expand ? "info" : pt(this.mutant.status)
          }"
    @click="${this.mutantClicked}" title="${this.mutant.mutatorName}">${
            this.mutant.id
          }</span></mutation-test-report-popup>`
      }
      renderPopupBody(e) {
        return O`<div slot="popover-body"><span class="btn">${ht(e.status)} ${
          e.status
        }</span>${this.renderDescription(e)}</div>`
      }
      renderDescription(e) {
        if (e.description)
          return O`<button class="show-more btn btn-link" @click="${() =>
            this.showMoreInfo(e)}">📖 Show more</button>`
      }
      renderCode() {
        return O`${this.renderReplacement()}${this.renderActual()}`
      }
      renderActual() {
        const e = O`<slot></slot>`
        return O`<span class="original-code ${
          this.expand && this.show ? "disabled-code" : ""
        }">${e}</span>`
      }
      renderReplacement() {
        if (this.mutant)
          return O`<span class="replacement badge badge-info" @click="${
            this.mutantClicked
          }" ?hidden="${!this.expand || !this.show}">${this.mutant
            .replacement || this.mutant.mutatorName}</span>`
      }
    }
    ;(bt.styles = [de, oe(n(11))]),
      mt([ee()], bt.prototype, "mutant", void 0),
      mt([ee()], bt.prototype, "show", void 0),
      mt([ee()], bt.prototype, "expand", void 0),
      mt([ee()], bt.prototype, "showPopup", void 0),
      (bt = mt([X("mutation-test-report-mutant")], bt))
    const gt = "show-more-click"
    class vt {
      constructor() {
        ;(this.killed = 0),
          (this.noCoverage = 0),
    ...
    xt.plugins.autoloader.languages_path =
    ...
    let _t = class extends se {
      ...
      render() {
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <mutation-test-report-file-legend @filters-changed="${
              this.filtersChanged
            }" @expand-all="${this.expandAll}"
              @collapse-all="${this.collapseAll}" .mutants="${
            this.model.mutants
      ...
      renderModalDialog() {
        return this.mutantInDialog
          ...
          <mutation-test-report-modal-dialog ?show="${
            this.mutantInDialog
          }" header="${this.mutantInDialog.id}: ${
              this.mutantInDialog.mutatorName
            } - ${ht(this.mutantInDialog.status)} ${
              this.mutantInDialog.status
            }">
  ...
  <tr>
      ...
      <td class="no-border-right vertical-middle">
        ${
          o
            ? O`
          <div class="progress">
            <div class="progress-bar bg-${i}" role="progressbar" aria-valuenow="${s}"
    ...
    ;(Pt.styles = [de, oe(n(23))]),
      Et([ee()], Pt.prototype, "model", void 0),
      Et([ee()], Pt.prototype, "thresholds", void 0),
      Et([ee()], Pt.prototype, "currentPath", void 0),
      (Pt = Et([X("mutation-test-report-totals")], Pt))
    ...
    `
      ...
      renderActiveItem(e) {
        return O`<li class="breadcrumb-item active" aria-current="page">${e}</li>`
      }
      renderLink(e, t) {
        return O`<li class="breadcrumb-item"><a href="${ft(t)}">${e}</a></li>`
      }
    }
    ;(jt.styles = [de]),
      Ct([ee()], jt.prototype, "path", void 0),
      (jt = Ct([X("mutation-test-report-breadcrumb")], jt))
    ...
    ;($t.styles = [de, oe(n(24))]),
      ...
      Nt([ee()], $t.prototype, "header", void 0),
      ($t = Nt([X("mutation-test-report-modal-dialog")], $t))
    var At = function(e, t, n, r) {
      var o,
        i = arguments.length,
        s =
        ...
        <div data-status="${e.status}" class="form-check form-check-inline">
          <label class="form-check-label">
            <input class="form-check-input" type="checkbox" ?checked="${
              e.enabled
            }" value="${e.status}" @input="${() => this.checkboxClicked(e)}">
            <span class="badge badge-${pt(e.status)}">${ht(e.status)}
              ${e.status} (${e.numberOfMutants})</span>
          </label>
        </div>
        `
        )}
    ...
    ;(Mt.styles = [de, oe(n(25))]),
      At([ee()], Mt.prototype, "mutants", void 0),
      At([ee()], Mt.prototype, "collapseButtonText", null),
      At([ee()], Mt.prototype, "collapsed", void 0),
      At([ee()], Mt.prototype, "filters", void 0),
      (Mt = At([X("mutation-test-report-file-legend")], Mt))
  },
])
