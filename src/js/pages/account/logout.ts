...
function init() {
    authenticator.logout().then(function() {
        ...
        alertBox.push(new SuccessAlert(`You have been successfully logged out. <a href="/account/login?continue=${Query.get("continue")}" class="alert-link preserve-state">Login again</a>`, false));
